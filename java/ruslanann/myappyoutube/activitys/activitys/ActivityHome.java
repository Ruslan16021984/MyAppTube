package ruslanann.myappyoutube.activitys.activitys;
...
import ruslanann.myappyoutube.R;
import ruslanann.myappyoutube.activitys.fragments.FragmentChannelVideo;
import ruslanann.myappyoutube.activitys.fragments.FragmentVideo;
import ruslanann.myappyoutube.activitys.utils.Utils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < channelId.length; i++) {
            primaryDrawerItems[i] = new PrimaryDrawerItem()
                    ...
                    .withIdentifier(i)
                    .withSelectable(false).withIcon(getResources()
        ...
        final AccountHeader accountHeader = new AccountHeaderBuilder()
                .withActivity(this)
                .withHeaderBackground(R.drawable.prodance)
                .build();
